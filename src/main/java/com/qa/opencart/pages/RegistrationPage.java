...
public class RegistrationPage {
    ...
    public boolean registerUser(String firstName, String lastName, String email, String telephone, String password,
        ...
        eleUtil.waitForElementVisible(this.firstName, MEDIUM_TIME_OUT).sendKeys(firstName);
        ...
        String successMessg = eleUtil.waitForElementVisible(this.successMessg,MEDIUM_TIME_OUT).getText();
        System.out.println(successMessg);
        if (successMessg.contains(USER_REGISTER_SUCCESS_MESSG)) {
